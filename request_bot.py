...
if os.path.exists(output_file):
    ...
    print(f"🗑️ Eski {output_file} silindi.")
...
for hotel_uid in hotel_uid_list:
    ...
    # Bu otel için fiyatları saklayacağız
        ...
        for room in breakdown_rooms:
            ...
            for week_index, week in enumerate(weeks):
                ...
                for day_index, day in enumerate(week):
                    ...
                    # Fiyatları süzmek için kontrol yapalım: Aynı boardType ve cancellationPolicy kombinasyonları varsa atlayalım
                    ...
                    # Fiyatları filtrele: Sadece 4 kombinasyonu almak
                    result_list.append({
